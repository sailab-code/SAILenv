...
class Network(torch.nn.Module):
	def __init__(self):
		...
		self.arguments_strModel = 'sintel'
		...
		self.load_state_dict({ strKey.replace('module', 'net'): tenWeight for strKey, tenWeight in torch.load(__file__.replace('run.py', 'network-' + self.arguments_strModel + '.pytorch')).items() })
	# end
